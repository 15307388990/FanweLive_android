...
public class InitActModel extends BaseActModel {
    ...
    private int bullet_screen_diamond = 100;// 弹幕一次消费的钻石
    ...
    private int is_open_smallvideo;//是否开启小视频功能

    private int inviter_is_open;//是否显示首页悬浮邀请按钮   值 = 1显示 、值 = 0 不显示
    private String inviter_img_url;////首页悬浮邀请按钮图片


    private int notice_is_open;//判断是否显示 系统公告   0：不显示   1：显示
    private String notice_url;//内容显示这个页面内容 可上下拖动
    private int video_notice_is_open;//状态等于1 直播间显示广告， 0：不显示
    private String video_notice_name;//点击广告词位置 必须[video_notice_url] = 不等于空  APP打开手机浏览器网址  //video_notice_url值为空 ，点击广告词不打开网址。
    private String video_notice_url;// “官方XX游戏，点击下载！”  //广告词
    private int smallvideo_is_open; //=1 显示   ，smallvideo_is_open = 0 不显示小视频
    private String smallvideo_name;// “小视频”  显示名称

    public int getNotice_is_open() {
        return notice_is_open;
    }

    public void setNotice_is_open(int notice_is_open) {
        this.notice_is_open = notice_is_open;
    }
    ...
    public int getInviter_is_open() {
        return inviter_is_open;
    }

    public void setInviter_is_open(int inviter_is_open) {
        this.inviter_is_open = inviter_is_open;
    }

    public String getInviter_img_url() {
        return inviter_img_url;
    }

    public void setInviter_img_url(String inviter_img_url) {
        this.inviter_img_url = inviter_img_url;
    }
    ...
    public int getIs_open_smallvideo() {
        return is_open_smallvideo;
    }

    public void setIs_open_smallvideo(int is_open_smallvideo) {
        this.is_open_smallvideo = is_open_smallvideo;
    }
    ...
    public int getVideo_notice_is_open() {
        return video_notice_is_open;
    }

    public void setVideo_notice_is_open(int video_notice_is_open) {
        this.video_notice_is_open = video_notice_is_open;
    }

    public String getVideo_notice_name() {
        return video_notice_name;
    }

    public void setVideo_notice_name(String video_notice_name) {
        this.video_notice_name = video_notice_name;
    }

    public String getVideo_notice_url() {
        return video_notice_url;
    }

    public void setVideo_notice_url(String video_notice_url) {
        this.video_notice_url = video_notice_url;
    }

    public int getSmallvideo_is_open() {
        return smallvideo_is_open;
    }

    public void setSmallvideo_is_open(int smallvideo_is_open) {
        this.smallvideo_is_open = smallvideo_is_open;
    }

    public String getSmallvideo_name() {
        return smallvideo_name;
    }

    public void setSmallvideo_name(String smallvideo_name) {
        this.smallvideo_name = smallvideo_name;
    }
}
