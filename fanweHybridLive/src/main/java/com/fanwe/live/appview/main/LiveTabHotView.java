...
import com.fanwe.live.view.HeaderGridView;
...
public class LiveTabHotView extends LiveTabBaseView {
    ...
    private void init() {
        ...
        lv_content = (SDProgressPullToRefreshGridView) findViewById(R.id.lv_content);
    ...
    private void addHeaderView() {
        ...
        lv_content.getRefreshableView().addHeaderView(mHeaderView);
    }
