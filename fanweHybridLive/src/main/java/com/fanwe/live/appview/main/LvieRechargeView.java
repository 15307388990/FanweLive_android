...
public class LvieRechargeView extends LiveTabBaseView {
    public LvieRechargeView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init();
    }

    public LvieRechargeView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public LvieRechargeView(Context context) {
        super(context);
        init();
    }
