...
public class AppRuntimeWorker
{
    ...
    public static int getSmallvideoIsOpen()
    {
        int SmallvideoIsOpen = 0;
        InitActModel model = InitActModelDao.query();
        if (model != null)
        {
            SmallvideoIsOpen = model.getSmallvideo_is_open();
        }
        return SmallvideoIsOpen;
    }
    ...
    public static String getSmallvideoName()
    {
        String smallvideoName = "";
        InitActModel model = InitActModelDao.query();
        if (model != null)
        {
            smallvideoName = model.getSmallvideo_name();
        }
        return smallvideoName;
    }
